...
def _add_line_chart(prs: Presentation):
    ...
    shape = slide.shapes.add_chart(XL_CHART_TYPE.LINE_MARKERS, x, y, cx, cy, chart_data)
    return shape.chart
...
def test_line_chart_defaults_legend_and_vary_by_categories():
    ...
    shape = slide.shapes.add_chart(XL_CHART_TYPE.LINE_MARKERS, 0, 0, 6_000_000, 4_000_000, data)
    chart = shape.chart
