...
def test_hyperlink_file_uri_roundtrip(tmp_path: Path):
    ...
    shp = slide.shapes.add_shape(MSO_AUTO_SHAPE_TYPE.ROUNDED_RECTANGLE, 0, 0, 2_000_000, 1_000_000)
...
def test_hyperlink_slide_anchor_via_target_slide_roundtrip():
    ...
    shp = slide1.shapes.add_shape(MSO_AUTO_SHAPE_TYPE.ROUNDED_RECTANGLE, 0, 0, 2_000_000, 1_000_000)
