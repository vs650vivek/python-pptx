...
class OptionalAttribute(BaseAttribute):
    ...
    def _docstring(self):
        ...
        return (
            ...
            f"``{self._attr_name}`` attribute, or |None| (or specified default value) "
            f"if not present. Assigning the default value causes the attribute to be "
            f"removed from the element."
        )
